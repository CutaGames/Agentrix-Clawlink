# Agentrix SDK Examples

This directory contains example code demonstrating how to use the Agentrix SDK.
...
```bash
export AGENTRIX_API_KEY="your-api-key-here"
export AGENTRIX_API_URL="http://localhost:3001/api"  # or production URL
export AGENTRIX_WEBHOOK_SECRET="your-webhook-secret"  # for webhook examples
```
