...
1. **修改位置**：
   - `paymindfrontend/hooks/useSessionManager.ts` - `createSession`函数
   - `paymindfrontend/components/payment/SessionManager.tsx` - `handleCreateSession`函数
...
1. 修改`paymindfrontend/components/payment/SmartCheckout.tsx`：
