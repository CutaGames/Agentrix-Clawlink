...
export function WatchSettingsScreen() {
    ...
    return (<ScrollView style={styles.container} contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.section}>
        ...
        {!isLoggedIn && (<TouchableOpacity style={styles.loginBtn}>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.chips}>
          {intervalOptions.map((opt) => (<TouchableOpacity key={opt.value} style={[
                styles.chip,
      ...
      <View style={styles.section}>
        ...
        <View style={styles.toggleRow}>
          ...
          <Switch value={notificationsEnabled} onValueChange={setNotificationsEnabled} trackColor={{ false: watchColors.textMuted, true: watchColors.primary }} thumbColor={watchColors.text}/>
        </View>
        <View style={styles.toggleRow}>
          <Text style={styles.rowLabel}>震动反馈</Text>
          <Switch value={hapticEnabled} onValueChange={setHapticEnabled} trackColor={{ false: watchColors.textMuted, true: watchColors.primary }} thumbColor={watchColors.text}/>
        </View>
      </View>
