...
function AuthNavigator() {
    return (<AuthStack.Navigator id={undefined} screenOptions={{ headerShown: false }}>
...
function OnboardingNavigator() {
    return (<OnboardingStack.Navigator id={undefined} screenOptions={{ headerShown: false }}>
...
function MainWithFloatingBall() {
    return (<View style={floatStyles.wrapper}>
      <DrawerNavigator />
      <GlobalFloatingBall />
    </View>);
}
...
export function RootNavigator() {
    ...
    return (<Root.Navigator id={undefined} screenOptions={{ headerShown: false, animation: 'fade' }}>
      {!isAuthenticated ? (<Root.Screen name="Auth" component={AuthNavigator}/>) : !hasValidInvitation ? (<Root.Screen name="InvitationGate" component={InvitationGateScreen}/>) : !hasCompletedOnboarding ? (<Root.Screen name="Onboarding" component={OnboardingNavigator}/>) : (<Root.Screen name="Main" component={MainWithFloatingBall}/>)}
    </Root.Navigator>);
}
