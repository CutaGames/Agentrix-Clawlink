...
export default function AllianceScreen({ navigation }) {
    ...
    return (<ScrollView style={s.container} showsVerticalScrollIndicator={false}>
      {/* Hero */}
      <View style={s.hero}>
      ...
      <View style={s.section}>
        ...
        {ROLES.map((role, i) => (<View key={i} style={s.roleCard}>
            ...
            {role.points.map((p, j) => (<Text key={j} style={s.rolePoint}>  • {t(p)}</Text>))}
          </View>))}
      </View>
      ...
      <View style={s.section}>
        ...
        {INCENTIVES.map((item, i) => (<View key={i} style={s.incentiveCard}>
      ...
      <View style={s.section}>
        ...
        <View style={s.stepsRow}>
          {STEPS.map((step, i) => (<View key={i} style={s.stepCard}>
