...
import { View, Text, ScrollView, TouchableOpacity, RefreshControl, StyleSheet, Alert, Share, } from 'react-native';
...
export function PromoteScreen({ navigation }) {
    const { t } = useI18n();
    ...
    return (<View style={styles.container}>
      <ScrollView refreshControl={<RefreshControl refreshing={refreshing} onRefresh={onRefresh} tintColor={colors.primary}/>} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.linkCard}>
            ...
            <View style={styles.linkActions}>
              ...
              <TouchableOpacity style={styles.linkActionBtn} onPress={() => navigation.navigate('MyLinks')}>
                <Text style={styles.linkActionIcon}>🔗</Text>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.hotSkillsRow}>
            {hotSkills.map(skill => (<TouchableOpacity key={skill.id} style={styles.hotSkillCard} onPress={() => handleShareSkill(skill)}>
        ...
        <View style={styles.section}>
          ...
          {links.slice(0, 3).map(link => (<View key={link.id} style={styles.linkItem}>
          ...
          {links.length === 0 && !loading && (<View style={styles.emptyLinks}>
        ...
        {/* 佣金规则入口 */}
        <TouchableOpacity style={styles.rulesBtn} onPress={() => navigation.navigate('CommissionRules')}>
      ...
      {/* ShareSheet Modal */}
      {shareTarget && (<ShareSheet visible={showShare} onClose={() => setShowShare(false)} target={shareTarget}/>)}
    </View>);
}
