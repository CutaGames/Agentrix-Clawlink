...
export function DeploySelectScreen() {
    ...
    return (<ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <View style={styles.options}>
        {OPTIONS.map((opt) => (<TouchableOpacity key={opt.id} style={[styles.card, opt.highlight && styles.cardHighlight]} activeOpacity={0.8} onPress={() => {
                if (opt.action) {
            ...
            <View style={styles.cardBody}>
              <View style={styles.cardTitleRow}>
                ...
                {opt.badge && (<View style={[styles.badge, { backgroundColor: opt.badgeColor + '22' }]}>
