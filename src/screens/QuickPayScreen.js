    ...
    return (<ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <Card>
        ...
        <View style={styles.amountInputContainer}>
          ...
          <TextInput style={styles.amountInput} placeholder="0.00" placeholderTextColor={colors.muted} keyboardType="decimal-pad" value={amount} onChangeText={setAmount}/>
        </View>
      </Card>
      ...
      <Card>
        ...
        <View style={styles.planList}>
          {mockPlans.map((plan) => (<TouchableOpacity key={plan.id} style={[
                styles.planItem,
      ...
      <PrimaryButton title="生成收款码" onPress={handleGenerate} disabled={numAmount <= 0}/>
    </ScrollView>);
};
