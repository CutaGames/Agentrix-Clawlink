...
export function AgentChatScreen() {
  ...
  const enqueueAttachment = async (localAttachment: {
    ...
    try {
      ...
      Alert.alert('Attachment Added', `${uploaded.originalName} is ready to send.`);

    } catch (error: any) {

      Alert.alert('Attachment Error', error?.message || 'Failed to upload attachment.');
...

      {
        ...
        onPress: async () => {
          ...
          try {
            ...
            const attachment = await DeviceBridgingService.pickImageAttachment();
            ...
            if (attachment) {
              ...
              await enqueueAttachment({
                ...
                fileName: attachment.fileName || 'selected-image.jpg',
...

      {
        ...
        onPress: async () => {
          ...
          try {
            ...
            const attachment = await DeviceBridgingService.pickFileAttachment();
  ...
  return (
    ...
    >
      ...
      {!!pendingAttachments.length && (
        ...
        <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.pendingAttachmentStrip}>
...
const styles = StyleSheet.create({
  ...
  attachmentImage: { width: 56, height: 56, borderRadius: 8, backgroundColor: colors.bg },
  ...
  pendingAttachmentStrip: { paddingHorizontal: 12, paddingTop: 10, gap: 8 },
  ...
  pendingAttachmentSub: { color: colors.textMuted, fontSize: 10 },

  pendingAttachmentRemove: { color: colors.textMuted, fontSize: 13, paddingLeft: 4 },
