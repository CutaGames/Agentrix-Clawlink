...
export function SkillDetailScreen({ route, navigation }) {
    ...
    return (<View style={styles.container}>
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        {/* Agent 兼容说明 */}
        {skill.agentCompatible && (<View style={styles.agentNote}>
        ...
        <View style={styles.section}>
          ...
          {skill.reviews.slice(0, 3).map((review) => (<View key={review.id} style={styles.reviewCard}>
          ...
          <View style={styles.reviewActions}>
            <TouchableOpacity style={styles.reviewActionBtn} onPress={() => navigation.navigate('Reviews', { skillId: skill.id })}>
              <Text style={styles.reviewActionText}>All Reviews</Text>
            </TouchableOpacity>
            <TouchableOpacity style={[styles.reviewActionBtn, styles.reviewActionBtnPrimary]} onPress={() => navigation.navigate('WriteReview', { skillId: skill.id })}>
