      ...
      {strategies.map((strategy) => (<Card key={strategy.id}>
          <View style={styles.strategyHeader}>
            <View style={styles.strategyInfo}>
              ...
              <View style={styles.strategyMeta}>
                ...
                <View style={[styles.riskBadge, { backgroundColor: riskColors[strategy.risk] }]}>
                  <Text style={styles.riskText}>{riskLabels[strategy.risk]}</Text>
                </View>
              </View>
            </View>
          ...
          <View style={styles.strategyActions}>
            <View style={styles.strategyToggle}>
              ...
              <Switch value={strategy.status === 'active'} onValueChange={() => toggleStrategy(strategy.id)} trackColor={{ false: colors.border, true: colors.primary }}/>
            </View>
            {strategy.deposited > 0 ? (<TouchableOpacity style={styles.manageBtn}>
                <Text style={styles.manageBtnText}>管理</Text>
              </TouchableOpacity>) : (<TouchableOpacity style={styles.joinBtn}>
