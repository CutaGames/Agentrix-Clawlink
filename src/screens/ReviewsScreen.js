...
export function ReviewsScreen({ route, navigation }) {
    ...
    const renderItem = ({ item }) => (<View style={styles.reviewCard}>
    ...
    const renderHeader = () => (<View style={styles.headerContainer}>
      ...
      <TouchableOpacity style={styles.writeBtn} onPress={() => navigation.navigate('WriteReview', { skillId })}>
    ...
    return (<View style={styles.container}>
      <FlatList data={reviews} renderItem={renderItem} keyExtractor={item => item.id} ListHeaderComponent={renderHeader} ListEmptyComponent={renderEmpty} refreshControl={<RefreshControl refreshing={refreshing} onRefresh={onRefresh} tintColor={colors.primary}/>} contentContainerStyle={styles.listContent} showsVerticalScrollIndicator={false}/>
    </View>);
}
