...
export function MvpProfileScreen({ navigation }) {
    ...
    return (<ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.quickStats}>
        <TouchableOpacity style={styles.quickStatItem} onPress={() => navigation.navigate('MyOrders')}>
          <Text style={styles.quickStatValue}>-</Text>
          <Text style={styles.quickStatLabel}>Orders</Text>
        </TouchableOpacity>
        <View style={styles.quickStatDivider}/>
        <TouchableOpacity style={styles.quickStatItem} onPress={() => navigation.navigate('MyFavorites')}>
          <Text style={styles.quickStatValue}>-</Text>
          <Text style={styles.quickStatLabel}>Saved</Text>
        </TouchableOpacity>
        <View style={styles.quickStatDivider}/>
        <TouchableOpacity style={styles.quickStatItem} onPress={() => navigation.navigate('MySkills')}>
          <Text style={styles.quickStatValue}>-</Text>
      ...
      <View style={styles.menuSection}>
        {menuItems.map((item, index) => (<TouchableOpacity key={index} style={[styles.menuItem, item.disabled && styles.menuItemDisabled]} onPress={() => {
                if (item.onPress) {
                    item.onPress();
                }
                else if (item.route) {
            ...
            {item.disabled && (<View style={styles.comingSoonBadge}>
                <Text style={styles.comingSoonText}>Soon</Text>
              </View>)}
            {!item.disabled && (<Text style={styles.menuArrow}>›</Text>)}
          </TouchableOpacity>))}
      </View>
