    ...
    return (<ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <Card>
        ...
        <View style={styles.identityList}>
          ...
          <View style={styles.identityItem}>
            ...
            <TouchableOpacity style={[styles.identityStatus, styles.statusLocked]} onPress={() => navigation.navigate('IdentityActivation', { identity: 'developer' })}>
      ...
      <Card>
        <View style={styles.menuList}>
          {menuItems.map((item, index) => (<TouchableOpacity key={index} style={styles.menuItem} onPress={() => item.screen && navigation.navigate(item.screen)}>
