...
import { View, Text, FlatList, TouchableOpacity, RefreshControl, StyleSheet, Alert, Share, } from 'react-native';
import { colors } from '../theme/colors';
import { referralApi } from '../services/referral.api';
export function MyLinksScreen({ navigation }) {
    ...
    const renderItem = ({ item }) => (<View style={styles.linkCard}>
    ...
    return (<View style={styles.container}>
      <FlatList data={links} renderItem={renderItem} keyExtractor={item => item.id} ListEmptyComponent={renderEmpty} refreshControl={<RefreshControl refreshing={refreshing} onRefresh={onRefresh} tintColor={colors.primary}/>} contentContainerStyle={styles.listContent} showsVerticalScrollIndicator={false}/>
    </View>);
}
