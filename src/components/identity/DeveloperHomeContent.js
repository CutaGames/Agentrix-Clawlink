...
export const DeveloperHomeContent = () => {
    ...
    return (<View style={styles.container}>
      ...
      <Card>
        ...
        <View style={styles.taskList}>
          {mockPendingTasks.map((task) => (<View key={task.id} style={styles.taskItem}>
              <View style={styles.taskInfo}>
                ...
                task.status === 'Pending' && styles.statusPrimary,
                    ...
                    {task.dueDate && (<Text style={styles.taskDue}>({task.dueDate})</Text>)}
                  </View>
                </View>
              </View>
            </View>))}
      ...
      <Card>
        ...
        <View style={styles.poolList}>
          {mockBudgetPools.map((pool) => (<TouchableOpacity key={pool.id} style={styles.poolItem} onPress={() => navigation.navigate('BudgetPools')}>
              <Text style={styles.poolName}>{pool.name}</Text>
              <Text style={styles.poolBudget}>${pool.budget.toLocaleString()}</Text>
            </TouchableOpacity>))}
        </View>
        <PrimaryButton title="View All" onPress={() => navigation.navigate('BudgetPools')}/>
      </Card>
      ...
      <Card>
        ...
        <PrimaryButton title="Browse Market" onPress={() => navigation.navigate('TaskMarket')}/>
      </Card>
    </View>);
};
