...
export const MerchantHomeContent = () => {
    ...
    return (<View style={styles.container}>
      ...
      <Card>
        ...
        <View style={styles.quickPayForm}>
          <View style={styles.inputRow}>
            ...
            <TextInput style={styles.amountInput} placeholder="Enter amount" placeholderTextColor={colors.muted} keyboardType="numeric" value={payAmount} onChangeText={setPayAmount}/>
          </View>
          ...
          <PrimaryButton title="Generate QR Code" onPress={() => navigation.navigate('QuickPay', { amount: payAmount })}/>
        </View>
      </Card>
      ...
      <Card>
        ...
        <View style={styles.orderList}>
          {mockRecentOrders.map((order) => (<View key={order.id} style={styles.orderItem}>
              <View>
      ...
      <Card>
        ...
        <View style={styles.planList}>
          {mockSplitPlans.map((plan) => (<TouchableOpacity key={plan.id} style={styles.planItem} onPress={() => navigation.navigate('SplitPlans')}>
              <View>
        ...
        <PrimaryButton title="Manage Plans" onPress={() => navigation.navigate('SplitPlans')}/>
      </Card>
    </View>);
};
