...
export class WearableVendorRegistryService {
    static enrichScanCandidate(candidate) {
    ...
    static getGestureHints(deviceName) {
        return this.matchByName(deviceName)?.gestureHints ?? [];
    }
    static matchByName(deviceName) {
    ...
    static mergeLabels(current, next) {
        return Array.from(new Set([...current, ...next]));
    }
    static promoteSupportTier(current, next) {
