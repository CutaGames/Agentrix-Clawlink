...
function AgentConsoleE2EScreen(props) {
    ...
    return (<View style={styles.wrapper}>
      ...
      <GlobalFloatingBall onVoiceActivate={() => props.navigation.navigate('AgentChat', {
...
function AgentChatE2EScreen(props) {
...
export function VoiceUiE2EApp() {
    return (<Stack.Navigator id={undefined} initialRouteName="AgentChat" screenOptions={{ headerShown: false }}>
