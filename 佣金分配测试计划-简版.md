...
| D001 | 开发者工具-无Agent | DEV_TOOL | dev_tool | developer: 80%, paymind: 5% |
| D002 | 开发者工具-双Agent | DEV_TOOL | dev_tool | developer: 80%, recommendation: 10%, execution: 5%, paymind: 5% |
...
**验证点**：
- [ ] Commission表中PayMind记录金额 = 3 USDT
...
最终分配：
- PayMind平台：0.5 + 2.5 = 3 USDT（包含返佣池）
- 商户：97 USDT
- 执行Agent：0 USDT
...
推广Agent分配（从PayMind基础收入中分20%）：
- 推广Agent：0.5 × 20% = 0.1 USDT
- PayMind最终收入：0.5 - 0.1 = 0.4 USDT
...
| 场景 | PayMind | 商户 | 执行Agent | 推荐Agent | 推广Agent | 返佣池 | 总计 |
|------|---------|------|-----------|-----------|-----------|--------|------|
