...
**相关文件**：
- `paymindfrontend/components/agent/StructuredResponseCard.tsx` - `handleAddToCart` 函数
- `paymindfrontend/lib/api/cart.api.ts` - `addItem` API调用
...
**相关文件**：
- `paymindfrontend/components/agent/SelectableCart.tsx`
