...
- [x] AutoPay 部署成功
- [x] Commission 部署成功
- [ ] Commission 配置了 settlementToken 和 paymindTreasury（需要运行配置脚本）
- [ ] 所有合约地址已更新到后端 `.env`
...
1. **Commission 配置**: Commission 合约部署后**必须**配置 `settlementToken` 和 `paymindTreasury` 才能正常工作
