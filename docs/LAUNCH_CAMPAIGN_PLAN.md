...
| **链支持** | 仅 Base | **BSC + BASE (可扩展)** |
| **开发者体验** | `npx skills add` | skill +**SDK (JS/Python/React) + MCP Server + OpenAPI** |
 ...
 **Agentrix Commerce** | Agentrix Commerce | "The Commerce Layer for AI Agents" | ⭐⭐⭐⭐⭐ **推荐** |
