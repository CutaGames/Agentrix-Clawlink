...
本文档列出了PayMind产品正式上线、生产环境使用前需要完成的所有关键工作。
...
- [ ] **前端环境变量** (`paymindfrontend/.env.production`)
  ```env
  NEXT_PUBLIC_API_URL=https://api.paymind.com/api
  NEXT_PUBLIC_APP_URL=https://paymind.com
