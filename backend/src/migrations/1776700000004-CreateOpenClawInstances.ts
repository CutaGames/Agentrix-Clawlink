...
/**
 * Creates the openclaw_instances table.
 * Base columns only — relay/subscription/OS columns are added by
 * AddSocialRelayToOpenClaw1776800000001.
 */
export class CreateOpenClawInstances1776700000004 implements MigrationInterface {
  name = 'CreateOpenClawInstances1776700000004';
