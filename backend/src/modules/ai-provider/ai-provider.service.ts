...
export const PROVIDER_CATALOG: ProviderDef[] = [
  ...
  },
  {
    ...
    models: [
      { id: 'claude-opus-4-20250514', label: 'Claude Opus 4 (最强)', contextWindow: 1000000, costTier: 'high', capabilities: ['chat', 'vision', 'function_calling'], multimodal: true, inputPrice: '$5.00', outputPrice: '$25.00', positioning: '深度推理/代码/长文本' },
      { id: 'claude-sonnet-4-20250514', label: 'Claude Sonnet 4', contextWindow: 1000000, costTier: 'medium', capabilities: ['chat', 'vision', 'function_calling'], multimodal: true, inputPrice: '$3.00', outputPrice: '$15.00', positioning: '均衡/默认/接近旗舰' },
      { id: 'claude-3-5-haiku-20241022', label: 'Claude Haiku 3.5', contextWindow: 200000, costTier: 'low', capabilities: ['chat', 'vision', 'function_calling'], multimodal: true, inputPrice: '$1.00', outputPrice: '$5.00', positioning: '轻量/快速/成本1/3' },
    ],
  },
  {
  ...
  },
  {
    ...
    models: [
      { id: 'us.anthropic.claude-opus-4-20250514-v1:0', label: 'Claude Opus 4', contextWindow: 1000000, costTier: 'high', capabilities: ['chat', 'vision', 'function_calling'], multimodal: true, inputPrice: '$5.00', outputPrice: '$25.00', positioning: '深度推理/代码/长文本' },
      { id: 'us.anthropic.claude-sonnet-4-20250514-v1:0', label: 'Claude Sonnet 4', contextWindow: 1000000, costTier: 'medium', capabilities: ['chat', 'vision', 'function_calling'], multimodal: true, inputPrice: '$3.00', outputPrice: '$15.00', positioning: '均衡/默认/接近旗舰' },
      ...
      { id: 'us.meta.llama4-maverick-17b-instruct-v1:0', label: 'Llama 4 Maverick', contextWindow: 1000000, costTier: 'low', capabilities: ['chat', 'vision', 'function_calling'], multimodal: true, inputPrice: '$0.20', outputPrice: '$0.60', positioning: '开源/私有化部署' },
      { id: 'us.meta.llama4-scout-17b-instruct-v1:0', label: 'Llama 4 Scout', contextWindow: 1000000, costTier: 'low', capabilities: ['chat', 'vision', 'function_calling'], multimodal: true, inputPrice: '$0.15', outputPrice: '$0.45', positioning: '轻量开源/快速推理' },
      ...
      { id: 'mistral.mistral-large-2402-v1:0', label: 'Mistral Large', contextWindow: 128000, costTier: 'medium', capabilities: ['chat', 'function_calling'], multimodal: false, inputPrice: '$2.00', outputPrice: '$6.00', positioning: '欧洲开源/代码/多语言' },
    ],
  },
  {
    ...
    models: [
      { id: 'anthropic.claude-sonnet-4-20250514-v1:0', label: 'Claude Sonnet 4 (中国区)', contextWindow: 200000, costTier: 'medium', capabilities: ['chat', 'vision', 'function_calling'], multimodal: true, inputPrice: '¥21.0', outputPrice: '¥105.0', positioning: '均衡/默认/中国区可用' },
      { id: 'anthropic.claude-3-5-haiku-20241022-v1:0', label: 'Claude Haiku 3.5 (中国区)', contextWindow: 200000, costTier: 'low', capabilities: ['chat', 'vision', 'function_calling'], multimodal: true, inputPrice: '¥5.6', outputPrice: '¥35.0', positioning: '轻量/快速/中国区可用' },
