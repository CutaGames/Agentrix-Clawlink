...
### `agentrixfrontend/components/auth/LoginModal.tsx`
...
在注册模式下，会额外显示 Agentrix ID 输入框（可选）。
...
3. **Agentrix ID**: 注册时可选，如果不填写会自动生成
