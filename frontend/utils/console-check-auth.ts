...
export const consoleCheckAuthCode = `
...
if (typeof window !== 'undefined') {
  // 创建一个可以直接执行的函数
  (window as any).checkAuth = new Function('return ' + consoleCheckAuthCode)();
  console.log('💡 授权诊断工具已加载');
  console.log('   使用方法: await window.checkAuth()');
  console.log('   或直接复制以下代码到控制台执行:');
  console.log(consoleCheckAuthCode);
}
