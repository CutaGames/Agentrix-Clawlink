...
- `agentrixfrontend/lib/api/agent-template.api.ts`
- `agentrixfrontend/components/agent/builder/AgentTemplateLibrary.tsx`
- `agentrixfrontend/components/agent/builder/AgentGenerator.tsx`
- `agentrixfrontend/components/agent/UnifiedAgentChat.tsx`
- `agentrixfrontend/components/agent/StructuredResponseCard.tsx`
- `agentrixfrontend/components/payment/SmartCheckout.tsx`
- `agentrixfrontend/lib/session-key-manager.ts`
- `agentrixfrontend/pages/_app.tsx`
- `agentrixfrontend/components/agent/AgentInsightsPanel.tsx`
