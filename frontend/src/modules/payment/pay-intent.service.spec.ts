...
describe('PayIntentService', () => {
  ...
  beforeEach(async () => {
    ...
    service = testingModule.get<PayIntentService>(PayIntentService);
    payIntentRepository = testingModule.get<Repository<PayIntent>>(getRepositoryToken(PayIntent));
    paymentService = testingModule.get<PaymentService>(PaymentService);
    quickPayGrantService = testingModule.get<QuickPayGrantService>(QuickPayGrantService);
  });
