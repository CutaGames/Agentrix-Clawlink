...
const mainNavItems = [
  { href: '/agent-enhanced', label: { zh: 'Agent', en: 'Agent' } },
  ...
  { href: '/use-cases', label: { zh: '使用场景', en: 'Use Cases' } },
        ...
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="flex items-center space-x-2">
            ...
            <button
              ...
              className="hidden items-center rounded-md bg-blue-600 px-3 py-2 text-sm font-semibold text-white transition-colors hover:bg-blue-700 md:inline-flex"
            >
              ⚡ Agent Builder
            </button>
            {/* 搜索功能暂时隐藏，可通过用户菜单访问 */}
