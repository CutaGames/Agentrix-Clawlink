  ...
  const allianceStats = [
    {
      ...
      sub: { zh: '执行 Agent、推荐 Agent、Agentrix 拆分清晰', en: 'Execution Agent, Referral Agent, Agentrix split clearly' },
    },
    {
    ...
    <>
      ...
      <main className="min-h-screen bg-slate-950 text-white">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-8">
                <p className="text-cyan-400 font-semibold uppercase tracking-[0.3em] text-xs">
                  {t({ zh: 'AGENTRIX 统一支付 × Agent 商业能力', en: 'AGENTRIX Unified Payment × Agent Business Capabilities' })}
                </p>
        ...
        <section className="border-b border-white/5 bg-gradient-to-b from-slate-950 to-slate-900">
          <div className="container mx-auto px-6 py-16 space-y-10">
            <div className="text-center space-y-4 mb-12">
              <p className="text-cyan-400 uppercase text-xs tracking-[0.4em]">{t({ zh: '为什么选择 Agentrix？', en: 'Why Agentrix?' })}</p>
        ...
        <section className="border-b border-white/5 bg-gradient-to-b from-slate-950 to-slate-900">
          <div className="container mx-auto px-6 py-16 space-y-10">
            <div className="text-center space-y-4">
              ...
              <h2 className="text-3xl md:text-4xl font-bold">{t({ zh: '3 个入口，立即开始使用 Agentrix', en: '3 Entry Points, Start Using Agentrix Now' })}</h2>
            </div>
            ...
            <div className="flex flex-col lg:flex-row gap-8 items-start">
              <div className="flex-1 space-y-4">
                ...
                <p className="text-slate-300 max-w-2xl">
                  {t({ zh: 'Agentrix 架构遵循「实时 Session 追踪 + 多链兼容 + 可审计分佣」原则，所有功能均可在 Sandbox 与脚本中直接验证。', en: 'Agentrix architecture follows "real-time Session tracking + multi-chain compatibility + auditable commission" principles, all features can be verified directly in Sandbox and scripts.' })}
                </p>
              </div>
        ...
        <section className="border-b border-white/5 bg-slate-900">
          <div className="container mx-auto px-6 py-16 space-y-10">
            <div className="text-center space-y-4">
              <p className="text-pink-300 uppercase text-xs tracking-[0.4em]">{t({ zh: '加入 Agentrix 生态', en: 'Join Agentrix Ecosystem' })}</p>
            ...
            <div className="grid md:grid-cols-3 lg:grid-cols-5 gap-6">
              ...
              <div className="bg-white/5 rounded-3xl border border-white/10 p-6 space-y-3 hover:border-pink-500/50 transition-all">
                ...
                <p className="text-sm text-slate-300">{t({ zh: '接入 Agentrix 生态，共同发展', en: 'Join Agentrix ecosystem, grow together' })}</p>
