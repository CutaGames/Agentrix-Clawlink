...
export default function MarketplacePage() {
  ...
  return (
    <>
      <Head>
        <title>Agentrix Marketplace｜AI 聚合资产与策略</title>
        <meta
          name="description"
          ...
          <div className="container mx-auto px-6 py-16 lg:py-24 grid lg:grid-cols-2 gap-10">
            <div className="space-y-6">
              ...
              <p className="text-slate-200">
                ...
                Agent 与商户只需配置资产和返佣，Agentrix Marketplace 立即执行。
              </p>
            ...
            <div className="bg-white/5 border border-white/10 rounded-3xl p-6 space-y-4">
              ...
              <div className="text-sm text-slate-300 space-y-2">
                ...
                <div className="flex justify-between">
                  <span>返佣模型</span>
                  <span>Agent 0.5% · 推广 Agent 0.5% · Agentrix 0.5%</span>
                </div>
                <div className="flex justify-between">
                  <span>运营状态</span>
        ...
        <section className="border-b border-white/5 bg-slate-950">
          <div className="container mx-auto px-6 py-16 space-y-8">
            <div className="text-center">
              ...
              <p className="text-slate-300 max-w-3xl mx-auto">
                Agent 面向用户展示完整流程，Agentrix 负责支付、合规、分润与托管。项目方只需配置资产与返佣。
              </p>
            </div>
        ...
        <section className="bg-gradient-to-r from-cyan-500 to-blue-600 py-20 text-center space-y-6">
          <div className="container mx-auto px-6 space-y-4">
            ...
            <p className="text-white/90 max-w-3xl mx-auto">
              连接 Agentrix Agent、统一支付、联盟分佣、资产聚合，让产品、策略、AI 智能体同步变现。
            </p>
