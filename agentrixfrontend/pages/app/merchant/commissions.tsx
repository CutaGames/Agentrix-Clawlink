        ...
        <div className="mb-8">
          ...
          <div className="mt-4 bg-blue-50 border border-blue-200 rounded-lg p-4">
            ...
            <div className="text-sm text-blue-800 space-y-1">
              <div>• <strong>实体商品</strong>：总佣金3%（推荐Agent 0.9% + 执行Agent 2.1% + Agentrix 0.5%）</div>
              <div>• <strong>服务类</strong>：总佣金5%（推荐Agent 1.5% + 执行Agent 3.5% + Agentrix 1%）</div>
