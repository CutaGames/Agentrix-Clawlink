...
export interface ArnSessionManagerInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "createSession"
      | "executeWithSession"
...
export namespace DailyLimitResetEvent {
  export type InputTuple = [sessionId: BytesLike, date: BigNumberish];
  export type OutputTuple = [sessionId: string, date: bigint];
...
export interface ArnSessionManager extends BaseContract {
  connect(runner?: ContractRunner | null): ArnSessionManager;
  waitForDeployment(): Promise<this>;

  interface: ArnSessionManagerInterface;
