  ...
  const kycLevels = [
    {
      ...
      name: '初级KYC',
      description: '基础身份验证，适用于小额交易',
      features: ['身份信息验证', '手机号验证', '邮箱验证'],
      limit: '单笔限额: ¥1,000 | 日限额: ¥5,000'
    },
    {
      level: 'verified' as KYCLevel,
      name: '第三方KYC',
      description: '完整的第三方KYC验证，适用于大额交易',
      features: ['身份信息验证', '人脸识别', '证件上传', '地址验证', '第三方认证'],
        ...
        <div className="max-w-4xl mx-auto">
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-lg font-semibold text-gray-900">
                    {user.kycLevel === 'none' ? '未认证' : user.kycLevel === 'basic' ? '初级KYC' : '第三方KYC'}
                  </p>
                </div>
                <div>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-6">
            ...
            <p className="text-blue-700 text-sm mb-4">
              通过PayMind的统一身份认证，您只需完成一次KYC验证，即可在所有支付通道中使用已验证的身份。
            </p>
            <div className="grid md:grid-cols-3 gap-4 text-sm">
              ...
              <div>
                <p className="font-semibold text-blue-900 mb-1">商户/Agent</p>
