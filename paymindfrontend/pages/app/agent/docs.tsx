  ...
  const apiDocs = [
    {
      ...
      description: '搜索商品',
      code: `const results = await paymind.agents.searchProducts('running shoes', {
  priceMax: 150
})`,
    },
    {
      ...
      description: '为用户创建订单',
      code: `const order = await paymind.agents.createOrder({
  productId: 'prod_123',
  userId: 'user_123',
  quantity: 1
})`,
      ...
      <div className="space-y-6">
        ...
        {activeTab === 'examples' && (
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <pre className="bg-gray-50 p-4 rounded-lg overflow-x-auto">
              <code className="text-sm">{`import { PayMind } from '@paymind/sdk'
...
// 搜索商品
const products = await paymind.agents.searchProducts('coffee')
