...
export default function Features() {
  ...
  return (
    <>
      <Head>
        <title>{t({ zh: 'PayMind 核心能力 - 所有能力都通过 Agent 提供', en: 'PayMind Core Capabilities - All Capabilities Provided Through Agent' })}</title>
        <meta
          name="description"
          content={t({
            zh: 'PayMind 核心能力：Agent 能力、支付能力、生态能力。所有能力都通过 Agent 提供。',
            en: 'PayMind core capabilities: Agent capabilities, payment capabilities, ecosystem capabilities. All capabilities are provided through Agent.',
          })}
        />
      </Head>
        ...
        <section className="border-b border-white/10 bg-gradient-to-br from-slate-900/90 to-blue-900/90 py-20">
          <div className="container mx-auto px-6">
            <div className="max-w-4xl mx-auto text-center space-y-6">
              <p className="text-xs uppercase tracking-[0.4em] text-cyan-300">PayMind Capabilities</p>
              <h1 className="text-4xl font-bold md:text-5xl lg:text-6xl">
                {t({ zh: 'PayMind 核心能力', en: 'PayMind Core Capabilities' })}
              </h1>
