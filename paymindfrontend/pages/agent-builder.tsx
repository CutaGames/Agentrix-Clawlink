...
export default function AgentBuilderPage() {
  ...
  return (
    <>
      <Head>
        <title>{t({ zh: 'PayMind Agent Builder - 5分钟生成你的 AI Agent', en: 'PayMind Agent Builder - Generate Your AI Agent in 5 Minutes' })}</title>
        <meta
          name="description"
          content={t({
            ...
            <div className="grid lg:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <p className="text-lg text-gray-600 mb-6">
                  {t({
                    zh: '从模板开始，自动配置支付、Auto-Earn、联盟分润与监控能力。即刻上线，加入 PayMind 联盟生态，获取 GMV 分成。',
                    en: 'Start from templates, automatically configure payment, Auto-Earn, alliance revenue sharing and monitoring capabilities. Go live immediately, join PayMind alliance ecosystem, get GMV share.',
                  })}
                </p>
