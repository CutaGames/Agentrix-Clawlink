...
export default function UserDemoPage() {
  ...
  return (
    <>
      <Head>
        <title>{t({ zh: '用户端支付演示 - PayMind', en: 'User Payment Demo - PayMind' })}</title>
        <meta
          name="description"
          content={t({
          ...
          <div className="container mx-auto px-6">
            <div className="max-w-4xl mx-auto text-center space-y-6">
              ...
              <p className="text-lg text-emerald-100 max-w-2xl mx-auto">
                {t({
                  zh: '无论是扫码支付、点击链接还是通过Agent购买，PayMind为您提供一致、安全、快速的支付体验',
                  en: 'Whether scanning QR code, clicking link or purchasing through Agent, PayMind provides consistent, secure and fast payment experience',
                })}
              </p>
            </div>
          </div>
                      ...
                      <div className="bg-slate-900 rounded-lg p-6">
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4">
                            <p className="text-xs text-blue-300 mb-1">{t({ zh: 'PayMind Agent', en: 'PayMind Agent' })}</p>
                            <p className="mb-3">
                              {t({
        ...
        <section className="py-16 border-b border-white/10">
          <div className="container mx-auto px-6">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-3xl font-bold text-center mb-12">
                {t({ zh: '为什么选择PayMind支付', en: 'Why Choose PayMind Payment' })}
              </h2>
