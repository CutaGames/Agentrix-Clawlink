...
export default function UnifiedPaymentDemo() {
    ...
    <div className="space-y-6">
      <div className="grid gap-4 md:grid-cols-2">
        {[
          ...
          {
            label: { zh: 'PayMind 佣金', en: 'PayMind commission' },
  ...
  return (
    <>
      <Head>
        <title>{t({ zh: '统一支付演示 - PayMind', en: 'Unified Payment Demo - PayMind' })}</title>
        <meta
          name="description"
          content={t({
            zh: '展示 PayMind 统一支付的多阶段流程，涵盖智能路由、QuickPay、托管与多货币展示。',
            en: 'Interactive walkthrough of PayMind unified payment with routing, QuickPay, escrow and FX.',
          })}
        />
      </Head>
        ...
        <section className="border-b border-white/10 bg-gradient-to-r from-cyan-600/30 to-blue-700/40 py-16">
          <div className="container mx-auto px-6">
            <div className="max-w-4xl space-y-5">
              <p className="text-xs uppercase tracking-[0.4em] text-cyan-200">{t({ zh: 'PayMind Unified Pay', en: 'PayMind Unified Pay' })}</p>
