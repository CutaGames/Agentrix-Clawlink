...
export default function SmartRoutingPage() {
  ...
  return (
    <>
      <Head>
        <title>{t({ zh: '智能路由演示 - PayMind', en: 'Smart routing demo - PayMind' })}</title>
        <meta
          name="description"
          content={t({
            zh: '模拟 PayMind 智能路由如何根据金额、KYC、QuickPay、钱包状态实时选择支付通道。',
            en: 'Simulate how PayMind routing picks the best channel with KYC, QuickPay and wallet context.',
          })}
        />
      </Head>
