...
export default function AgentExperience() {
  ...
  return (
    <>
      <Head>
        <title>Agent 体验｜PayMind</title>
        <meta
          name="description"
          content="PayMind Agent 页面展示：对话、支付、资产、联盟在一个操作台完成，真实还原 AI 商业体工作流。"
        />
      </Head>
          ...
          <div className="container mx-auto px-6 py-16 md:py-24 grid lg:grid-cols-2 gap-10 items-center">
            <div className="space-y-6">
              ...
              <p className="text-slate-200">
                用户看到的是对话体验，商户与开发者看到的是可视化工作台。PayMind Agent 同时具备 AI 能力、支付编排、智能路由、
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-3 text-xs">
                    ...
                    <div className="bg-white/5 rounded-xl p-3">
                      ...
                      <p className="text-lg font-semibold text-white">执行 2.1 · 推荐 0.9 · PayMind 0.5</p>
                    </div>
                  </div>
                </div>
              </div>
