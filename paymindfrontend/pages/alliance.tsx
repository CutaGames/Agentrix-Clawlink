...
const personas = [
  ...
  },
  {
    icon: '🤖',
    title: 'Agent 开发者',
    description: '通过 SDK / API 将 PayMind 的支付、资产与联盟能力嵌入自己的 Agent 或 App。',
...
export default function AlliancePage() {
  ...
  return (
    <>
      <Head>
        <title>PayMind 联盟 - 通过 Agent 参与，获得永久收益</title>
        <meta name="description" content="通过 Agent 参与 PayMind 联盟，推广商户、推荐 Agent、推广 Marketplace 和插件，获得永久分佣收益。" />
      </Head>
      ...
      <main className="bg-slate-950 text-white">
        ...
        <section className="bg-gradient-to-r from-indigo-600 via-blue-600 to-purple-700 py-20 text-white text-center">
          <div className="container mx-auto px-6 space-y-6">
            <h2 className="text-4xl font-bold">一起共建 PayMind AI 经济联盟</h2>
