...
export default function UseCases() {
  ...
  return (
    <>
      <Head>
        <title>{t({ zh: 'PayMind 使用场景 - 4 种 Agent 角色，覆盖所有商业场景', en: 'PayMind Use Cases - 4 Agent Roles, Covering All Business Scenarios' })}</title>
        <meta
          name="description"
          content={t({
            zh: 'PayMind 使用场景：个人 Agent、商户 Agent、开发者 Agent、推广 Agent 四大场景，覆盖所有商业需求。',
            en: 'PayMind use cases: Personal Agent, Merchant Agent, Developer Agent, Promoter Agent - four major scenarios covering all business needs.',
          })}
        />
      </Head>
          ...
          <div className="container mx-auto px-6">
            <div className="max-w-4xl mx-auto text-center space-y-6">
              ...
              <h1 className="text-4xl font-bold md:text-5xl lg:text-6xl">
                {t({ zh: 'PayMind 使用场景', en: 'PayMind Use Cases' })}
              </h1>
