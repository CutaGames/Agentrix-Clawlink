    ...
    <div className="relative w-full max-w-5xl mx-auto py-12">
      <svg viewBox="0 0 800 600" className="w-full h-auto">
        ...
        <text x="400" y="270" textAnchor="middle" fill="#c4b5fd" fontSize="11">
          PayMind-Brain (MoE) + PayMind-Nano (SLM)
        </text>
...
const architectureLayers = [
  ...
  },
  {
    ...
    description: {
      zh: 'PayMind-Brain（云端混合专家）：风险专家、财务专家、合约专家。PayMind-Nano（端侧小模型）：Qwen3 0.6B，负责意图前置、离线推理。',
      en: 'PayMind-Brain (Cloud MoE): Risk, Finance, Contract experts. PayMind-Nano (Edge SLM): Qwen3 0.6B for intent pre-processing and offline inference.',
    },
    features: [
...
export default function EdgePage() {
  ...
  return (
    <>
      <Head>
        <title>PayMind Edge - AI 驱动的 POS 智能助手</title>
        <meta name="description" content="PayMind Edge：基于 Qwen3 0.6B 端侧模型的 POS AI Agent，支持语音收银、智能推荐、离线处理。" />
      </Head>
          ...
          <div className="container mx-auto px-6">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
                {t({ zh: 'PayMind 五层架构', en: 'PayMind Pentagonal Architecture' })}
              </h2>
            ...
            <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
              <div className="rounded-2xl border border-white/10 bg-white/5 p-8">
                ...
                <p className="text-slate-300 text-sm mb-4">
                  {t({
                    zh: '与 POS 厂家合作，在新出货设备中预装 PayMind Edge runtime + Qwen 0.6B 模型。硬件统一、NPU/NFC/外设适配一次性完成。',
                    en: 'Partner with POS manufacturers to pre-install PayMind Edge runtime + Qwen 0.6B model in new devices. Unified hardware, one-time NPU/NFC/peripheral adaptation.',
                  })}
                </p>
