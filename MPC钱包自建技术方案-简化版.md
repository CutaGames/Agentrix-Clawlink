...
export class MPCWalletService {
  ...
  async authorizeAutoSplit(
    ...
    // 商户授权 PayMind 在限额内自动使用分片 B + C 签名
    // 生成授权令牌
...
paymindfrontend/components/mpc-wallet/
...
contract MerchantMultiSig {
    ...
    address public paymind;       // PayMind 地址
    ...
    function executeTransaction(
        ...
        // 需要 2/3 签名
        require(hasApproval(merchant) || hasApproval(paymind) || hasApproval(backup), "Need 2 approvals");
        // 执行交易
    }
}
```
